...
namespace Nop.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        private void UpdateCustomerStats(int customerId)
        {
            ...
            _genericAttributeService.SaveAttribute(customer, NopCustomersDefaults.ForumPostCountAttribute, numPosts);
        }
        ...
        public virtual void DeleteForumGroup(ForumGroup forumGroup)
        {
            ...
            _cacheManager.RemoveByPattern(NopForumsDefaults.ForumGroupPatternCacheKey);
            _cacheManager.RemoveByPattern(NopForumsDefaults.ForumPatternCacheKey);
        ...
        {
            return _cacheManager.Get(NopForumsDefaults.ForumGroupAllCacheKey, () =>
            {
        ...
        {
            var key = string.Format(NopForumsDefaults.ForumAllByForumGroupIdCacheKey, forumGroupId);
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            //UI notification
            _genericAttributeService.SaveAttribute(customerTo, NopCustomersDefaults.NotifiedAboutNewPrivateMessagesAttribute, false, privateMessage.StoreId);
