...
namespace Nop.Services.Topics
{
    ...
    public partial class TopicService : ITopicService
    {
        ...
        public virtual void DeleteTopic(Topic topic)
        {
            ...
            //cache
            _cacheManager.RemoveByPattern(NopTopicsDefaults.TopicsPatternCacheKey);
        ...
        public virtual Topic GetTopicById(int topicId)
        {
            ...
            var key = string.Format(NopTopicsDefaults.TopicsByIdCacheKey, topicId);
        ...
        {
            var key = string.Format(NopTopicsDefaults.TopicsAllCacheKey, storeId, ignorAcl, showHidden);
