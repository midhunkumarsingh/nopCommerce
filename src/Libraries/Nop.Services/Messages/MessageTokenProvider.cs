...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public virtual void AddCustomerTokens(IList<Token> tokens, Customer customer)
        {
            ...
            tokens.Add(new Token("Customer.FirstName", customer.GetAttribute<string>(NopCustomersDefaults.FirstNameAttribute)));
            tokens.Add(new Token("Customer.LastName", customer.GetAttribute<string>(NopCustomersDefaults.LastNameAttribute)));
            tokens.Add(new Token("Customer.VatNumber", customer.GetAttribute<string>(NopCustomersDefaults.VatNumberAttribute)));
            tokens.Add(new Token("Customer.VatNumberStatus", ((VatNumberStatus)customer.GetAttribute<int>(NopCustomersDefaults.VatNumberStatusIdAttribute)).ToString()));

            var customAttributesXml = customer.GetAttribute<string>(NopCustomersDefaults.CustomCustomerAttributes);
            ...
            var passwordRecoveryUrl = RouteUrl(routeName: "PasswordRecoveryConfirm", routeValues: new { token = customer.GetAttribute<string>(NopCustomersDefaults.PasswordRecoveryTokenAttribute), email = customer.Email });
            var accountActivationUrl = RouteUrl(routeName: "AccountActivation", routeValues: new { token = customer.GetAttribute<string>(NopCustomersDefaults.AccountActivationTokenAttribute), email = customer.Email });
            var emailRevalidationUrl = RouteUrl(routeName: "EmailRevalidation", routeValues: new { token = customer.GetAttribute<string>(NopCustomersDefaults.EmailRevalidationTokenAttribute), email = customer.Email });
        ...
        public virtual void AddVendorTokens(IList<Token> tokens, Vendor vendor)
        {
            ...
            var vendorAttributesXml = vendor.GetAttribute<string>(NopVendorsDefaults.VendorAttributes);
