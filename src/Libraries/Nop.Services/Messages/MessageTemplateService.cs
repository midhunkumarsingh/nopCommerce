...
namespace Nop.Services.Messages
{
    ...
    public partial class MessageTemplateService: IMessageTemplateService
    {
        ...
        public virtual void DeleteMessageTemplate(MessageTemplate messageTemplate)
        {
            ...
            _cacheManager.RemoveByPattern(NopMessagesDefaults.MessageTemplatesPatternCacheKey);
        ...
        public virtual IList<MessageTemplate> GetMessageTemplatesByName(string messageTemplateName, int? storeId = null)
        {
            ...
            var key = string.Format(NopMessagesDefaults.MessageTemplatesByNameCacheKey, messageTemplateName, storeId ?? 0);
        ...
        {
            var key = string.Format(NopMessagesDefaults.MessageTemplatesAllCacheKey, storeId);
            return _cacheManager.Get(key, () =>
            {
