...
namespace Nop.Services.Themes
{
    ...
    public partial class ThemeProvider : IThemeProvider
    {
        ...
        public IList<ThemeDescriptor> GetThemes()
        {
            ...
            var themeDirectoryPath = _fileProvider.MapPath(NopPluginsDefaults.ThemesPath);
            foreach (var descriptionFile in _fileProvider.GetFiles(themeDirectoryPath, NopPluginsDefaults.ThemeDescriptionFileName, false))
            {
