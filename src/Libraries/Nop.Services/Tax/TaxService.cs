...
namespace Nop.Services.Tax
{
    ...
    public partial class TaxService : ITaxService
    {
        ...
        protected virtual bool IsEuConsumer(Customer customer)
        {
            ...
            {
                var countryId = customer.GetAttribute<int>(NopCustomersDefaults.CountryIdAttribute);
            ...
            var customerVatStatus = (VatNumberStatus)customer.GetAttribute<int>(NopCustomersDefaults.VatNumberStatusIdAttribute);
            ...
            int taxCategoryId, Customer customer, decimal price)
        {
            ...
            {
                var pickupPoint = customer.GetAttribute<PickupPoint>(NopCustomersDefaults.SelectedPickupPointAttribute, _storeContext.CurrentStore.Id);
                if (pickupPoint != null)
                {
