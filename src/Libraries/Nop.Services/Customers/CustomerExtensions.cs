...
namespace Nop.Services.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static string GetFullName(this Customer customer)
        {
            ...
            var firstName = customer.GetAttribute<string>(NopCustomersDefaults.FirstNameAttribute);
            var lastName = customer.GetAttribute<string>(NopCustomersDefaults.LastNameAttribute);
        ...
        public static string FormatUserName(this Customer customer, bool stripTooLong = false, int maxLength = 0)
        {
            ...
            switch (EngineContext.Current.Resolve<CustomerSettings>().CustomerNameFormat)
            {
                ...
                case CustomerNameFormat.ShowFirstName:
                    result = customer.GetAttribute<string>(NopCustomersDefaults.FirstNameAttribute);
                    break;
                default:
                    break;
            }
        ...
        public static string[] ParseAppliedDiscountCouponCodes(this Customer customer)
        {
            ...
            var existingCouponCodes = customer.GetAttribute<string>(NopCustomersDefaults.DiscountCouponCodeAttribute,
        ...
        public static void ApplyDiscountCouponCode(this Customer customer, string couponCode)
        {
            ...
            //apply new value
            genericAttributeService.SaveAttribute(customer, NopCustomersDefaults.DiscountCouponCodeAttribute, result);
        }
        ...
        public static void RemoveDiscountCouponCode(this Customer customer, string couponCode)
        {
            ...
            //clear them
            var genericAttributeService = EngineContext.Current.Resolve<IGenericAttributeService>();
            genericAttributeService.SaveAttribute<string>(customer, NopCustomersDefaults.DiscountCouponCodeAttribute, null);
        ...
        public static string[] ParseAppliedGiftCardCouponCodes(this Customer customer)
        {
            ...
            var genericAttributeService = EngineContext.Current.Resolve<IGenericAttributeService>();
            var existingCouponCodes = customer.GetAttribute<string>(NopCustomersDefaults.GiftCardCouponCodesAttribute,
                genericAttributeService);
        ...
        public static void ApplyGiftCardCouponCode(this Customer customer, string couponCode)
        {
            ...
            //apply new value
            genericAttributeService.SaveAttribute(customer, NopCustomersDefaults.GiftCardCouponCodesAttribute, result);
        }
        ...
        public static void RemoveGiftCardCouponCode(this Customer customer, string couponCode)
        {
            ...
            //clear them
            var genericAttributeService = EngineContext.Current.Resolve<IGenericAttributeService>();
            genericAttributeService.SaveAttribute<string>(customer, NopCustomersDefaults.GiftCardCouponCodesAttribute, null);
        ...
        public static bool IsPasswordRecoveryTokenValid(this Customer customer, string token)
        {
            ...
            var cPrt = customer.GetAttribute<string>(NopCustomersDefaults.PasswordRecoveryTokenAttribute);
        ...
        public static bool IsPasswordRecoveryLinkExpired(this Customer customer, CustomerSettings customerSettings)
        {
            ...
            var geneatedDate = customer.GetAttribute<DateTime?>(NopCustomersDefaults.PasswordRecoveryTokenDateGeneratedAttribute);
        ...
        public static bool PasswordIsExpired(this Customer customer)
        {
            ...
            var cacheKey = string.Format(NopCustomerServicesDefaults.CustomerPasswordLifetimeCacheKey, customer.Id);
