...
namespace Nop.Services.Vendors
{
    ...
    public partial class VendorAttributeService : IVendorAttributeService
    {
        ...
        {
            return _cacheManager.Get(NopVendorsServicesDefaults.VendorAttributesAllCacheKey, () =>
            {
        ...
        public virtual VendorAttribute GetVendorAttributeById(int vendorAttributeId)
        {
            ...
            var key = string.Format(NopVendorsServicesDefaults.VendorAttributesByIdCacheKey, vendorAttributeId);
        ...
        public virtual void InsertVendorAttribute(VendorAttribute vendorAttribute)
        {
            ...
            _cacheManager.RemoveByPattern(NopVendorsServicesDefaults.VendorAttributesPatternCacheKey);
            _cacheManager.RemoveByPattern(NopVendorsServicesDefaults.VendorAttributeValuesPatternCacheKey);
        ...
        {
            var key = string.Format(NopVendorsServicesDefaults.VendorAttributeValuesAllCacheKey, vendorAttributeId);
        ...
        public virtual VendorAttributeValue GetVendorAttributeValueById(int vendorAttributeValueId)
        {
            ...
            var key = string.Format(NopVendorsServicesDefaults.VendorAttributeValuesByIdCacheKey, vendorAttributeValueId);
