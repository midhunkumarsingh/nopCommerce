...
namespace Nop.Services.Orders
{
    ...
    public partial class CheckoutAttributeService : ICheckoutAttributeService
    {
        ...
        public virtual void DeleteCheckoutAttribute(CheckoutAttribute checkoutAttribute)
        {
            ...
            _cacheManager.RemoveByPattern(NopOrdersDefaults.CheckoutAttributesPatternCacheKey);
            _cacheManager.RemoveByPattern(NopOrdersDefaults.CheckoutAttributeValuesPatternCacheKey);
        ...
        {
            var key = string.Format(NopOrdersDefaults.CheckoutAttributesAllCacheKey, storeId, excludeShippableAttributes);
        ...
        public virtual CheckoutAttribute GetCheckoutAttributeById(int checkoutAttributeId)
        {
            ...
            var key = string.Format(NopOrdersDefaults.CheckoutAttributesByIdCacheKey, checkoutAttributeId);
        ...
        {
            var key = string.Format(NopOrdersDefaults.CheckoutAttributeValuesAllCacheKey, checkoutAttributeId);
            return _cacheManager.Get(key, () =>
            {
        ...
        public virtual CheckoutAttributeValue GetCheckoutAttributeValueById(int checkoutAttributeValueId)
        {
            ...
            var key = string.Format(NopOrdersDefaults.CheckoutAttributeValuesByIdCacheKey, checkoutAttributeValueId);
