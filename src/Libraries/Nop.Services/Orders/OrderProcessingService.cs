    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        protected virtual PlaceOrderContainer PreparePlaceOrderDetails(ProcessPaymentRequest processPaymentRequest)
        {
            ...
            var currencyTmp = _currencyService.GetCurrencyById(
                details.Customer.GetAttribute<int>(NopCustomersDefaults.CurrencyIdAttribute, processPaymentRequest.StoreId));
            ...
            details.CustomerLanguage = _languageService.GetLanguageById(
                details.Customer.GetAttribute<int>(NopCustomersDefaults.LanguageIdAttribute, processPaymentRequest.StoreId));
            ...
            //checkout attributes
            details.CheckoutAttributesXml = details.Customer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, processPaymentRequest.StoreId);
            ...
            if (_taxSettings.AllowCustomersToSelectTaxDisplayType)
                details.CustomerTaxDisplayType = (TaxDisplayType)details.Customer.GetAttribute<int>(NopCustomersDefaults.TaxDisplayTypeIdAttribute, processPaymentRequest.StoreId);
            else
            ...
            {
                var pickupPoint = details.Customer.GetAttribute<PickupPoint>(NopCustomersDefaults.SelectedPickupPointAttribute, processPaymentRequest.StoreId);
                ...
                var shippingOption = details.Customer.GetAttribute<ShippingOption>(NopCustomersDefaults.SelectedShippingOptionAttribute, processPaymentRequest.StoreId);
            ...
            //VAT number
            var customerVatStatus = (VatNumberStatus)details.Customer.GetAttribute<int>(NopCustomersDefaults.VatNumberStatusIdAttribute);
            if (_taxSettings.EuVatEnabled && customerVatStatus == VatNumberStatus.Valid)
                details.VatNumber = details.Customer.GetAttribute<string>(NopCustomersDefaults.VatNumberAttribute);
        ...
        public virtual void ReOrder(Order order)
        {
            ...
            _genericAttributeService.SaveAttribute(order.Customer, NopCustomersDefaults.CheckoutAttributes, order.CheckoutAttributesXml, order.StoreId);
        }
