    ...
    public partial class OrderTotalCalculationService : IOrderTotalCalculationService
    {
            ...
            bool? useRewardPoints, Customer customer, decimal orderTotal)
        {
            ...
            if (!useRewardPoints.HasValue)
                useRewardPoints = customer.GetAttribute<bool>(NopCustomersDefaults.UseRewardPointsDuringCheckoutAttribute, _genericAttributeService, _storeContext.CurrentStore.Id);
            ...
            out SortedDictionary<decimal, decimal> taxRates)
        {
            ...
            if (customer != null)
            {
                var checkoutAttributesXml = customer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, _genericAttributeService, _storeContext.CurrentStore.Id);
            ...
            out decimal taxRate, out List<DiscountForCaching> appliedDiscounts)
        {
            ...
            if (customer != null)
                shippingOption = customer.GetAttribute<ShippingOption>(NopCustomersDefaults.SelectedShippingOptionAttribute, _genericAttributeService, _storeContext.CurrentStore.Id);
