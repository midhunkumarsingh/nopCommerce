    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
            ...
            bool ensureOnlyActiveCheckoutAttributes = false)
        {
                ...
                shoppingCartItem.ShoppingCartType == ShoppingCartType.ShoppingCart)
            {
                ...
                var checkoutAttributesXml = customer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, _genericAttributeService, storeId);
                checkoutAttributesXml = _checkoutAttributeParser.EnsureOnlyActiveAttributes(checkoutAttributesXml, cart);
                _genericAttributeService.SaveAttribute(customer, NopCustomersDefaults.CheckoutAttributes, checkoutAttributesXml, storeId);
            }
        ...
        public virtual void MigrateShoppingCart(Customer fromCustomer, Customer toCustomer, bool includeCouponCodes)
        {
            ...
            var checkoutAttributesXml = fromCustomer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, _genericAttributeService, _storeContext.CurrentStore.Id);
            _genericAttributeService.SaveAttribute(toCustomer, NopCustomersDefaults.CheckoutAttributes, checkoutAttributesXml, _storeContext.CurrentStore.Id);
        }
