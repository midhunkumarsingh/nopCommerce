...
namespace Nop.Services.Shipping
{
    ...
    public partial class ShippingService : IShippingService
    {
            ...
            bool includeCheckoutAttributes = true, bool ignoreFreeShippedItems = false)
        {
            ...
            {
                var checkoutAttributesXml = request.Customer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, _genericAttributeService, _storeContext.CurrentStore.Id);
