    ...
    public static class AffiliateExtensions
    {
        ...
        public static string GenerateUrl(this Affiliate affiliate, IWebHelper webHelper)
        {
            ...
            var url = !string.IsNullOrEmpty(affiliate.FriendlyUrlName) ?
                //use friendly URL
                webHelper.ModifyQueryString(storeUrl, NopAffiliatesDefaults.AffiliateQueryParameter, affiliate.FriendlyUrlName) :
                //use ID
                webHelper.ModifyQueryString(storeUrl, NopAffiliatesDefaults.AffiliateIdQueryParameter, affiliate.Id.ToString());
        ...
        public static string ValidateFriendlyUrlName(this Affiliate affiliate, string friendlyUrlName)
        {
            ...
            friendlyUrlName = CommonHelper.EnsureMaximumLength(friendlyUrlName, NopAffiliatesDefaults.FriendlyUrlNameLength);
