...
namespace Nop.Services.Stores
{
    ...
    public partial class StoreService : IStoreService
    {
        ...
        public virtual void DeleteStore(Store store)
        {
            ...
            _cacheManager.RemoveByPattern(NopStoresDefaults.StoresPatternCacheKey);
        ...
        public virtual IList<Store> GetAllStores(bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                return _cacheManager.Get(NopStoresDefaults.StoresAllCacheKey, () =>
                {
        ...
        public virtual Store GetStoreById(int storeId, bool loadCacheableCopy = true)
        {
            ...
            {
                //cacheable copy
                var key = string.Format(NopStoresDefaults.StoresByIdCacheKey, storeId);
