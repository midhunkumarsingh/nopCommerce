...
namespace Nop.Core.Domain.Customers
{
    ...
    /// </summary>
    public static partial class NopCustomersDefaults
    {
        ...
        /// </summary>
        public static string AdministratorsRole => "Administrators";

        /// <summary>
        /// Gets a system name of 'forum moderators' customer role
        /// </summary>
        public static string ForumModeratorsRole => "ForumModerators";

        /// <summary>
        /// Gets a system name of 'registered' customer role
        /// </summary>
        public static string RegisteredRole => "Registered";

        /// <summary>
        /// Gets a system name of 'guests' customer role
        /// </summary>
        public static string GuestsRole => "Guests";

        /// <summary>
        /// Gets a system name of 'vendors' customer role
        /// </summary>
        public static string VendorsRole => "Vendors";
        ...
        /// </summary>
        public static string SearchEngineCustomer => "SearchEngine";

        /// <summary>
        /// Gets a system name of 'background task' customer object
        /// </summary>
        public static string BackgroundTaskCustomer => "BackgroundTask";
