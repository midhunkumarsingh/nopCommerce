...
namespace Nop.Core.Domain.Customers
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool IsSearchEngineAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(NopCustomersDefaults.SearchEngineCustomer, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        public static bool IsBackgroundTaskAccount(this Customer customer)
        {
            ...
            var result = customer.SystemName.Equals(NopCustomersDefaults.BackgroundTaskCustomer, StringComparison.InvariantCultureIgnoreCase);
            return result;
        }
        ...
        {
            return IsInCustomerRole(customer, NopCustomersDefaults.AdministratorsRole, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, NopCustomersDefaults.ForumModeratorsRole, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, NopCustomersDefaults.RegisteredRole, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, NopCustomersDefaults.GuestsRole, onlyActiveCustomerRoles);
        }
        ...
        {
            return IsInCustomerRole(customer, NopCustomersDefaults.VendorsRole, onlyActiveCustomerRoles);
        }
