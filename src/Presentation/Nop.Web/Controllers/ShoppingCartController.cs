...
namespace Nop.Web.Controllers
{
    public partial class ShoppingCartController : BasePublicController
    {
        ...
        protected virtual void ParseAndSaveCheckoutAttributes(List<ShoppingCartItem> cart, IFormCollection form)
        {
            ...
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, NopCustomersDefaults.CheckoutAttributes, attributesXml, _storeContext.CurrentStore.Id);
        }
        ...
        public virtual IActionResult CheckoutAttributeChange(IFormCollection form, bool isEditable)
        {
            ...
            var attributeXml = _workContext.CurrentCustomer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes,
        ...
        {
            var returnUrl = _workContext.CurrentCustomer.GetAttribute<string>(NopCustomersDefaults.LastContinueShoppingPageAttribute, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult StartCheckout(IFormCollection form)
        {
            ...
            //validate attributes
            var checkoutAttributes = _workContext.CurrentCustomer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, _genericAttributeService, _storeContext.CurrentStore.Id);
