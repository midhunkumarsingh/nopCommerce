...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual IActionResult Index()
        {
            ...
            //validation (cart)
            var checkoutAttributesXml = _workContext.CurrentCustomer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, _genericAttributeService, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult SelectBillingAddress(int addressId, bool shipToSameAddress = false)
        {
            ...
            if (_shippingSettings.ShipToSameAddress && shipToSameAddress && cart.RequiresShipping(_productService, _productAttributeParser) && address.Country.AllowsShipping)
            {
                ...
                _genericAttributeService.SaveAttribute<ShippingOption>(_workContext.CurrentCustomer, NopCustomersDefaults.SelectedShippingOptionAttribute, null, _storeContext.CurrentStore.Id);
                _genericAttributeService.SaveAttribute<PickupPoint>(_workContext.CurrentCustomer, NopCustomersDefaults.SelectedPickupPointAttribute, null, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult NewShippingAddress(CheckoutShippingAddressModel model)
        {
            ...
            if (_shippingSettings.AllowPickUpInStore)
            {
                if (model.PickUpInStore)
                {
                    ...
                    _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, NopCustomersDefaults.SelectedShippingOptionAttribute, pickUpInStoreShippingOption, _storeContext.CurrentStore.Id);
                    _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, NopCustomersDefaults.SelectedPickupPointAttribute, selectedPoint, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult ShippingMethod()
        {
                ...
                model.ShippingMethods.Count == 1)
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, 
                    NopCustomersDefaults.SelectedShippingOptionAttribute,
        ...
        public virtual IActionResult SelectShippingMethod(string shippingoption)
        {
            ...
            if (!cart.RequiresShipping(_productService, _productAttributeParser))
            {
                _genericAttributeService.SaveAttribute<ShippingOption>(_workContext.CurrentCustomer,
                    NopCustomersDefaults.SelectedShippingOptionAttribute, null, _storeContext.CurrentStore.Id);
                return RedirectToRoute("CheckoutPaymentMethod");
            }
            ...
            var shippingOptions = _workContext.CurrentCustomer.GetAttribute<List<ShippingOption>>(NopCustomersDefaults.OfferedShippingOptionsAttribute, _storeContext.CurrentStore.Id);
            ...
            //save
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, NopCustomersDefaults.SelectedShippingOptionAttribute, shippingOption, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult PaymentMethod()
        {
            ...
            if (!isPaymentWorkflowRequired)
            {
                _genericAttributeService.SaveAttribute<string>(_workContext.CurrentCustomer,
                    NopCustomersDefaults.SelectedPaymentMethodAttribute, null, _storeContext.CurrentStore.Id);
                ...
                paymentMethodModel.PaymentMethods.Count == 1 && !paymentMethodModel.DisplayRewardPoints)
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    NopCustomersDefaults.SelectedPaymentMethodAttribute, 
        ...
        public virtual IActionResult SelectPaymentMethod(string paymentmethod, CheckoutPaymentMethodModel model)
        {
            ...
            {
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                    NopCustomersDefaults.UseRewardPointsDuringCheckoutAttribute, model.UseRewardPoints,
                    _storeContext.CurrentStore.Id);
            }
            ...
            //save
            _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer,
                NopCustomersDefaults.SelectedPaymentMethodAttribute, paymentmethod, _storeContext.CurrentStore.Id);
        ...
        public virtual IActionResult EnterPaymentInfo(IFormCollection form)
        {
            ...
            var paymentMethodSystemName = _workContext.CurrentCustomer
                .GetAttribute<string>(NopCustomersDefaults.SelectedPaymentMethodAttribute, _genericAttributeService, _storeContext.CurrentStore.Id);
            var paymentMethod = _paymentService.LoadPaymentMethodBySystemName(paymentMethodSystemName);
            if (paymentMethod == null)
                return RedirectToRoute("CheckoutPaymentMethod");
