    ...
    public partial class ShoppingCartModelFactory : IShoppingCartModelFactory
    {
        ...
        protected virtual IList<ShoppingCartModel.CheckoutAttributeModel> PrepareCheckoutAttributeModels(IList<ShoppingCartItem> cart)
        {
            ...
            foreach (var attribute in checkoutAttributes)
            {
                ...
                var selectedCheckoutAttributes = _workContext.CurrentCustomer.GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, _genericAttributeService, _storeContext.CurrentStore.Id);
        ...
        protected virtual ShoppingCartModel.OrderReviewDataModel PrepareOrderReviewDataModel(IList<ShoppingCartItem> cart)
        {
            ...
            if (cart.RequiresShipping(_productService, _productAttributeParser))
            {
                ...
                var pickupPoint = _workContext.CurrentCustomer.GetAttribute<PickupPoint>(NopCustomersDefaults.SelectedPickupPointAttribute,_storeContext.CurrentStore.Id);
                ...
                var shippingOption = _workContext.CurrentCustomer.GetAttribute<ShippingOption>(NopCustomersDefaults.SelectedShippingOptionAttribute, _storeContext.CurrentStore.Id);
                if (shippingOption != null)
                    model.ShippingMethod = shippingOption.Name;
            }

            //payment info
            var selectedPaymentMethodSystemName = _workContext.CurrentCustomer.GetAttribute<string>(NopCustomersDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
        ...
        public virtual string FormatSelectedCheckoutAttributes()
        {
            var checkoutAttributesXml = _workContext.CurrentCustomer
                .GetAttribute<string>(NopCustomersDefaults.CheckoutAttributes, _genericAttributeService, _storeContext.CurrentStore.Id);
        ...
        public virtual OrderTotalsModel PrepareOrderTotalsModel(IList<ShoppingCartItem> cart, bool isEditable)
        {
            ...
            if (cart.Any())
            {
                ...
                //payment method fee
                var paymentMethodSystemName = _workContext.CurrentCustomer.GetAttribute<string>(NopCustomersDefaults.SelectedPaymentMethodAttribute, _storeContext.CurrentStore.Id);
