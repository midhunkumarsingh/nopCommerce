    ...
    public partial class CustomerModelFactory : ICustomerModelFactory
    {
        ...
        public virtual IList<CustomerAttributeModel> PrepareCustomCustomerAttributes(Customer customer, string overrideAttributesXml = "")
        {
            ...
            foreach (var attribute in customerAttributes)
            {
                ...
                var selectedAttributesXml = !string.IsNullOrEmpty(overrideAttributesXml) ?
                    ...
                    customer.GetAttribute<string>(NopCustomersDefaults.CustomCustomerAttributes, _genericAttributeService);
            ...
            bool excludeProperties, string overrideCustomCustomerAttributesXml = "")
        {
            ...
            if (!excludeProperties)
            {
                ...
                var dateOfBirth = customer.GetAttribute<DateTime?>(NopCustomersDefaults.DateOfBirthAttribute);
                ...
                model.Signature = customer.GetAttribute<string>(NopCustomersDefaults.SignatureAttribute);
            ...
            model.VatNumberStatusNote = ((VatNumberStatus)customer.GetAttribute<int>(NopCustomersDefaults.VatNumberStatusIdAttribute))
        ...
        public virtual CustomerAvatarModel PrepareCustomerAvatarModel(CustomerAvatarModel model)
        {
            ...
            model.AvatarUrl = _pictureService.GetPictureUrl(
                _workContext.CurrentCustomer.GetAttribute<int>(NopCustomersDefaults.AvatarPictureIdAttribute),
