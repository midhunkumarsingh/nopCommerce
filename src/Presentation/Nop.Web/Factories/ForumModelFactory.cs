        ...
        public virtual ForumTopicPageModel PrepareForumTopicPageModel(ForumTopic forumTopic, int page)
        {
            ...
            foreach (var post in posts)
            {
                var forumPostModel = new ForumPostModel
                {
                    ...
                    ForumPostCount = post.Customer.GetAttribute<int>(NopCustomersDefaults.ForumPostCountAttribute),
                    ...
                    FormattedSignature = post.Customer.GetAttribute<string>(NopCustomersDefaults.SignatureAttribute).FormatForumSignatureText(),
                };
                //created on string
                ...
                if (_customerSettings.AllowCustomersToUploadAvatars)
                {
                    forumPostModel.CustomerAvatarUrl = _pictureService.GetPictureUrl(
                        post.Customer.GetAttribute<int>(NopCustomersDefaults.AvatarPictureIdAttribute),
                ...
                {
                    var countryId = post.Customer.GetAttribute<int>(NopCustomersDefaults.CountryIdAttribute);
