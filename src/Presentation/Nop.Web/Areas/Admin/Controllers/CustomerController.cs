...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class CustomerController : BaseAdminController
    {
        ...
        protected virtual string ValidateCustomerRoles(IList<CustomerRole> customerRoles)
        {
            ...
            var isInGuestsRole = customerRoles.FirstOrDefault(cr => cr.SystemName == NopCustomersDefaults.GuestsRole) != null;
            var isInRegisteredRole = customerRoles.FirstOrDefault(cr => cr.SystemName == NopCustomersDefaults.RegisteredRole) != null;
        ...
        {
            var customers = _customerService.GetAllCustomers(customerRoleIds: new[] { _customerService.GetCustomerRoleBySystemName(NopCustomersDefaults.AdministratorsRole).Id });
        ...
        public virtual IActionResult Create(CustomerModel model, bool continueEditing)
        {
            ...
            if (newCustomerRoles.Any() && newCustomerRoles.FirstOrDefault(c => c.SystemName == NopCustomersDefaults.RegisteredRole) != null &&
            ...
            if (ModelState.IsValid)
            {
                ...
                if (_customerSettings.DateOfBirthEnabled)
                    _genericAttributeService.SaveAttribute(customer, NopCustomersDefaults.DateOfBirthAttribute, model.DateOfBirth);
                ...
                foreach (var customerRole in newCustomerRoles)
                {
                    ...
                    if (customerRole.SystemName == NopCustomersDefaults.AdministratorsRole && !_workContext.CurrentCustomer.IsAdmin())
                        continue;
                ...
                if (customer.IsVendor() && customer.VendorId == 0)
                {
                    var vendorRole = customer
                        .CustomerRoles
                        .FirstOrDefault(x => x.SystemName == NopCustomersDefaults.VendorsRole);
            ...
            if (ModelState.IsValid)
            {
                try
                {
                        ...
                        if (!string.IsNullOrEmpty(model.VatNumber))
                        {
                            if (!model.VatNumber.Equals(prevVatNumber, StringComparison.InvariantCultureIgnoreCase))
                            {
                                _genericAttributeService.SaveAttribute(customer,
                                    NopCustomersDefaults.VatNumberStatusIdAttribute,
                    ...
                    foreach (var customerRole in allCustomerRoles)
                    {
                        ...
                        if (customerRole.SystemName == NopCustomersDefaults.AdministratorsRole &&
                        ...
                        else
                        {
                            ...
                            if (customerRole.SystemName == NopCustomersDefaults.AdministratorsRole && !SecondAdminAccountExists(customer))
                            {
        ...
        public virtual IActionResult Impersonate(int id)
        {
            ...
            _customerService.UpdateCustomer(customer);
            _genericAttributeService.SaveAttribute<int?>(_workContext.CurrentCustomer, NopCustomersDefaults.ImpersonatedCustomerIdAttribute, customer.Id);
        ...
        public virtual IActionResult LoadCustomerStatistics(string period)
        {
            ...
            var searchCustomerRoleIds = new[] { _customerService.GetCustomerRoleBySystemName(NopCustomersDefaults.RegisteredRole).Id };
