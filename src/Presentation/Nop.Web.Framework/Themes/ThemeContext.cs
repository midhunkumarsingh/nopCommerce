        ...
        public string WorkingThemeName
        {
            get
            {
                ...
                if (_storeInformationSettings.AllowCustomerToSelectTheme && _workContext.CurrentCustomer != null)
                    themeName = _workContext.CurrentCustomer.GetAttribute<string>(NopCustomersDefaults.WorkingThemeNameAttribute, _genericAttributeService, _storeContext.CurrentStore.Id);
            ...
            set
            {
                ...
                _genericAttributeService.SaveAttribute(_workContext.CurrentCustomer, 
                    NopCustomersDefaults.WorkingThemeNameAttribute, value, _storeContext.CurrentStore.Id);
